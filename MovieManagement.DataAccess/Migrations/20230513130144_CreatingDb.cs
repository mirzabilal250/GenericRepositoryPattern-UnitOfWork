    ...
    public partial class CreatingDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Amazing movie of Bilal", "Fast Five" },
                    { 2, 2, "Amazing movie of Aizaz", "Fast Five" },
                    { 3, 1, "Amazing movie of Bilal", "Matrix" },
                    { 4, 3, "Amazing movie of Adeel", "Superman" }
                });
